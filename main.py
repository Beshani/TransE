...
def main(_):
    ...
    train_set = data.Dataset_Loader(train_path, entity2id, relation2id)
    train_generator = torch_data.DataLoader(train_set, batch_size=batch_size)
    validation_set = data.Dataset_Loader(validation_path, entity2id, relation2id)
    validation_generator = torch_data.DataLoader(validation_set, batch_size=FLAGS.validation_batch_size)
    test_set = data.Dataset_Loader(test_path, entity2id, relation2id)
    ...
    print("Total time to train for all epochs:", total_time, "seconds")
